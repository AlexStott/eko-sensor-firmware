...
void mcp9800_init()
{
       ...
       LDByteWriteI2C(I2C_MCP9800_ADDR, 0x01, 0x30);
}
int mcp9800_get_temp()
{
		...
		LDByteReadI2C(I2C_MCP9800_ADDR, I2C_MCP9800_TA, &temp1, 2);
        temp = ((0x00FF & temp1) << 8) + ((0xFF00 & temp1) >> 8);
...
/*        // Write the register address for writing to the command register
        ...
        reset_i2c_bus();
*/
		LDByteWriteI2C(I2C_TSL2561_ADDR, I2C_TSL2561_CONTROL, I2C_TSL2561_CONTROL_PWRON);
}

unsigned char tsl2561_get_reg(unsigned char command_reg_value)
{
        unsigned char data;
		LDByteReadI2C(I2C_TSL2561_ADDR, command_reg_value, &data, 1);
		return data;
        /*i2c_start();
